...
#ifndef _C_RENDER_BROWSER_H_
#define _C_RENDER_BROWSER_H_
...
namespace chen{
	...
	void __declspec(dllimport)  browser_startup(const char * url,uint32_t width, uint32_t height, uint32_t fps, set_gpu_addresses_callback callback, bool show = false);
#endif 
	}
#endif // 